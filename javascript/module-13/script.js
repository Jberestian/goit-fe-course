...
//
// let str = 'BANK : SVENSKA HANDELSBANKEN AB';
// let reg = /HAND/;
//
// console.log((str.match(reg)));/

// //
// let str = 'Card Name : Lucas Caamaño Viale\n' +
//     'Expiration : 02/2020\n' +
...
// var qwe = '12345, www. www h - whwhwh',
//     regV = /\w/g;
//
// console.log(qwe.match(regV));

// let number = '92345 123 243 467 5234 987';
// regV = /\b[0-9]{3}\b/g;
//
// console.log(number.match(regV));
...
//     '.++=======[ CC Info ]=======++.\n' +
//     'Name: HIROKO MIYATA\n' +
//     'Credit Card Number: 3761 283359 430101\n' +
...
//     'City     : Ashiya';
//
// let number = /((?<=Card Number.:.)|(?<=Card Number:.)).+/g;
//
// console.log(card.match(number));

// let asd =+38(068)123-45-67;

// let reg2 = /\+\d{2}\(\d{3}\)\d{3}\-\d{2}\-\d{2}|/g;
//
// console.log(reg2.test(prompt()));
...
function valide() {
    ...
    if( regMail.test(mail.value)&&(regPass.test(pass.value)) ) {
        console.log('valide');
    } else {
        console.log('goHome');
    }
    if(regPass.test(pass.value)&&(regMail.test(mail.value))) {
        console.log('good');
    } else {
        console.log('fackHome');
    }
